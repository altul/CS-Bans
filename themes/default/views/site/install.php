...
<?php if(count($error)): ?>
	...
	<b>Installation is not possible. Resolve the following issues:</b><br>
...
<?php else: ?>
	...
	<fieldset>
		<legend>Data to connect to the database</legend>
	...
	<br>
	<?php echo CHtml::submitButton('To install', array('class' => 'btn btn-primary')); ?><br>
